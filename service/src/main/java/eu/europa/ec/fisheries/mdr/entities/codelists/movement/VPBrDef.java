...
@Entity
@Table(name = "mdr_vp_br_def")
@Indexed
@Analyzer(impl = StandardAnalyzer.class)
public class VPBrDef extends MasterDataRegistry {

    private static final long serialVersionUID = 1L;

    @Id
    @Column(name = "id", unique = true, nullable = false)
    @SequenceGenerator(name = "VP_BR_DEF_SEQ_GEN", sequenceName = "mdr_vp_br_def_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "VP_BR_DEF_SEQ_GEN")
    private long id;
    ...
    public void populate(MDRDataNodeType mdrDataType) throws FieldNotMappedException {
        ...
        for (MDRElementDataNodeType field : mdrDataType.getSubordinateMDRElementDataNodes()) {
            ...
            if (StringUtils.equalsIgnoreCase(fieldName, "VP_BR_DEF.FIELD")) {
