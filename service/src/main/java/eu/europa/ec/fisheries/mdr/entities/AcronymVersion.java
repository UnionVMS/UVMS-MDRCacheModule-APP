...
public class AcronymVersion implements Serializable {
    ...
    @SequenceGenerator(name = "ACRONYM_VERSION_SEQ_GEN", sequenceName = "mdr_acronymversion_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ACRONYM_VERSION_SEQ_GEN")
    private long id;
