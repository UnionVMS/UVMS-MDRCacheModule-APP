...
public class FluxFaReportType extends MasterDataRegistry {
	...
	@SequenceGenerator(name = "FLUX_FA_REPORT_TYPE_SEQ_GEN", sequenceName = "mdr_flux_fa_report_type_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "FLUX_FA_REPORT_TYPE_SEQ_GEN")
	private long id;
