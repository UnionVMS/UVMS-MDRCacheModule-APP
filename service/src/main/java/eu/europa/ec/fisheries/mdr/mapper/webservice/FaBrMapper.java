...
import eu.europa.ec.fisheries.mdr.entities.codelists.ers.FaBr;
import eu.europa.ec.fisheries.mdr.qualifiers.MDRMapper;
import eu.europa.ec.mare.fisheries.services.mdr.v1.MDRDataNodeType;

@ApplicationScoped
@MDRMapper("FA_BR")
public class FaBrMapper extends MasterDataRegistryMapper {
    ...
    public MasterDataRegistry mapMDRDataNodeTypeToEntity(MDRDataNodeType mdrDataNodeType) {
        ...
        entity.setFluxGpValidationLevelEnDescr(getProperty(mdrDataNodeType, FGVT_ENDESCRIPTION));
