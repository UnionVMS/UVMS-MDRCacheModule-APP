...
public class FaCharacteristic extends MasterDataRegistry {
    ...
    @SequenceGenerator(name = "FA_CHARACTERISTIC_SEQ_GEN", sequenceName = "mdr_fa_characteristic_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "FA_CHARACTERISTIC_SEQ_GEN")
    private long id;
