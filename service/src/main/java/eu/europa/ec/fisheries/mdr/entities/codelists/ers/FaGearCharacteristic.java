...
public class FaGearCharacteristic extends MasterDataRegistry {
    ...
    @SequenceGenerator(name = "FA_GEAR_CHARACTERISTIC_SEQ_GEN", sequenceName = "mdr_fa_gear_characteristic_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "FA_GEAR_CHARACTERISTIC_SEQ_GEN")
    private long id;
