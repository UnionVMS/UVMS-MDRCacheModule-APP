...
public class FluxGpParty extends MasterDataRegistry {
    ...
    @SequenceGenerator(name = "FLUX_GP_PARTY_SEQ_GEN", sequenceName = "mdr_flux_gp_party_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "FLUX_GP_PARTY_SEQ_GEN")
    private long id;
