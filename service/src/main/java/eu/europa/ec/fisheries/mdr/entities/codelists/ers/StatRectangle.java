...
public class StatRectangle extends MasterDataRegistry {
    ...
    @SequenceGenerator(name = "STAT_RECTANGLE_SEQ_GEN", sequenceName = "mdr_statistical_rectangle_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "STAT_RECTANGLE_SEQ_GEN")
    private long id;
