...
public class FishFreshness extends MasterDataRegistry {
	...
	@SequenceGenerator(name = "FISH_FRESHNESS_SEQ_GEN", sequenceName = "mdr_fish_freshness_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "FISH_FRESHNESS_SEQ_GEN")
	private long id;
