...
public class SaleBr extends MasterDataRegistry {
    ...
    @SequenceGenerator(name = "SALE_BR_SEQ_GEN", sequenceName = "mdr_sale_br_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SALE_BR_SEQ_GEN")
    private long id;
