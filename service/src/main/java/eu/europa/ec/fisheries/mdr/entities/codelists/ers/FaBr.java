...
public class FaBr extends MasterDataRegistry {
    ...
    @SequenceGenerator(name = "FA_BR_SEQ_GEN", sequenceName = "mdr_fa_br_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "FA_BR_SEQ_GEN")
    private long id;
    ...
    //FLUX_GP_VALIDATION_LEVEL.CODE,
    //FLUX_GP_VALIDATION_LEVEL.ENDESCRIPTION
