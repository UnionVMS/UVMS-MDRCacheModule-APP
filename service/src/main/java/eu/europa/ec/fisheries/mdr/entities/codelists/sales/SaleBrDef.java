...
public class SaleBrDef extends MasterDataRegistry {
    ...
    @SequenceGenerator(name = "SALE_BR_DEF_SEQ_GEN", sequenceName = "mdr_sale_br_def_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SALE_BR_DEF_SEQ_GEN")
    private long id;
