...
public class FishPackaging extends MasterDataRegistry {
	...
	@SequenceGenerator(name = "FISH_PACKAGING_SEQ_GEN", sequenceName = "mdr_fish_packaging_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "FISH_PACKAGING_SEQ_GEN")
	private long id;
