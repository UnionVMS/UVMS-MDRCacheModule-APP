...
@Stateless
@Slf4j
public class ConfigConsumerBeanImpl extends AbstractConsumer implements ConfigMessageConsumer {

    private final static Logger LOG = LoggerFactory.getLogger(ConfigConsumerBeanImpl.class);
