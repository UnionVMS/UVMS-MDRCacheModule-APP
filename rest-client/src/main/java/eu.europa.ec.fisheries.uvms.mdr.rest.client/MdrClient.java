...
package eu.europa.ec.fisheries.uvms.mdr.rest.client;
...
public interface MdrClient {

    void syncMdrCodeList(FLUXMDRReturnMessage fluxmdrReturnMessage);

    MdrGetCodeListResponse getSingleMdrCodeListMessage(MdrGetCodeListRequest request);

    MdrGetCodeListResponse getStatusRequest();
